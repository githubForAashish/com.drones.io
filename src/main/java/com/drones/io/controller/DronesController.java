...
public class DronesController {
  ...
  public ResponseEntity<DroneDTO> registerDrone(
      @Valid @RequestBody final RegisterDroneRequestSchema drone) {
  ...
  public ResponseEntity<DroneDTO> loadDrone(
      @PathVariable String droneSerialNumber,
      @Valid @RequestBody final List<MedicationDTO> medications) {
